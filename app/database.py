...
def init_db(connection: sqlite3.Connection | None = None) -> None:
    ...
    try:
        db.executescript(
            ...
            CREATE UNIQUE INDEX IF NOT EXISTS idx_agents_wallet_chain
            ON agents(lower(owner_wallet), chain_id);
            ...
            CREATE TABLE IF NOT EXISTS agent_tasks (
                ...
                status TEXT NOT NULL CHECK(status IN ('planned', 'requires_signature', 'executed', 'completed', 'rejected', 'failed')),
                mode TEXT NOT NULL CHECK(mode IN ('metamask', 'autonomous')),
